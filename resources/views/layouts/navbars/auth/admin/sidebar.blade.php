<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('admin.dashboard') }}">
            ...
            <span class="ms-3 font-weight-bold">Halo {{ Auth::user()->name ?? '' }},
                <span class="text-secondary">{{ ucfirst(Auth::user()->roles[0]->name ?? '') }}</span></span>
        </a>
    </div>
                ...
                <a class="nav-link {{ Request::is('user-management') ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <i style="font-size: 1rem;"
                            class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark"
                            aria-hidden="true"></i>
                    </div>
